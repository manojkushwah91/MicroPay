  ...
  useEffect(() => {
    ...
    const loadNotifications = async () => {
      ...
      try {
        ...
        const userFriendlyMessage = err.userFriendlyMessage || err.response?.data?.userFriendlyMessage || 'Failed to load notifications';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8 animate-fade-in">
        ...
        <p className="text-fintech-300 text-lg">View all your notifications</p>
      </div>
